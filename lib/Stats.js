...
Stats.jsonToString = function jsonToString(obj, useColors) {
	...
	if(obj.assets && obj.assets.length > 0) {
		var t = [
			[
				{value: "Asset", color: colors.normal},
				{value: "Size", color: colors.normal},
				{value: "Chunks", color: colors.normal},
				{value: "", color: colors.normal},
				{value: "Chunk Names", color: colors.normal}
			]
		];
